...
class Moderation(GraphNode[nodetool.nodes.openai.text.Moderation.OutputType]):
    ...
    input: str | OutputHandle[str] = connect_field(default='', description='The text content to check for policy violations.')
    model: nodetool.nodes.openai.text.ModerationModel = Field(default=nodetool.nodes.openai.text.ModerationModel.OMNI_MODERATION_LATEST, description='The moderation model to use.')
