...
class RealtimeAgent(GraphNode[nodetool.nodes.openai.agents.RealtimeAgent.OutputType]):
    ...
    chunk: types.Chunk | OutputHandle[types.Chunk] = connect_field(default=types.Chunk(type='chunk', node_id=None, thread_id=None, workflow_id=None, content_type='text', content='', content_metadata={}, done=False), description='The audio chunk to use as input.')
