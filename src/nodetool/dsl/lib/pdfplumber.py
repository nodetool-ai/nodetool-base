...
class ExtractTables(SingleOutputGraphNode[typing.Any], GraphNode[typing.Any]):
    ...
    table_settings: dict | OutputHandle[dict] = connect_field(default={'vertical_strategy': 'text', 'horizontal_strategy': 'text', 'snap_tolerance': 3, 'join_tolerance': 3, 'edge_min_length': 3, 'min_words_vertical': 3, 'min_words_horizontal': 1, 'text_keep_blank_chars': False, 'text_tolerance': 3, 'text_x_tolerance': 3, 'text_y_tolerance': 3}, description='Settings for table extraction algorithm')
