...
class DecisionTreeClassifierNode(GraphNode):
    ...
    DecisionTreeCriterion: typing.ClassVar[type] = (
        nodetool.nodes.lib.ml.sklearn.tree.DecisionTreeCriterion
    )
    ...
    criterion: nodetool.nodes.lib.ml.sklearn.tree.DecisionTreeCriterion = Field(
        default=nodetool.nodes.lib.ml.sklearn.tree.DecisionTreeCriterion.GINI,
    ...
    def get_node_type(cls):
        return "lib.ml.sklearn.tree.DecisionTreeClassifier"
...
class DecisionTreeRegressorNode(GraphNode):
    ...
    DecisionTreeRegressorCriterion: typing.ClassVar[type] = (
        nodetool.nodes.lib.ml.sklearn.tree.DecisionTreeRegressorCriterion
    )
    X_train: types.NPArray | GraphNode | tuple[GraphNode, str] = Field(
        default=types.NPArray(type="np_array", value=None, dtype="<i8", shape=(1,)),
        description="Training features",
    ...
    criterion: nodetool.nodes.lib.ml.sklearn.tree.DecisionTreeRegressorCriterion = (
        Field(
            default=nodetool.nodes.lib.ml.sklearn.tree.DecisionTreeRegressorCriterion.SQUARED_ERROR,
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.ml.sklearn.tree.DecisionTreeRegressor"
