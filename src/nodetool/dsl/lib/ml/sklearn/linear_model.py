...
class LassoRegressionNode(GraphNode):
    ...
    def get_node_type(cls):
        return "lib.ml.sklearn.linear_model.LassoRegression"
...
class LinearRegressionNode(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.ml.sklearn.linear_model.LinearRegression"
...
class LogisticRegressionNode(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.ml.sklearn.linear_model.LogisticRegression"
...
class RidgeRegressionNode(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.ml.sklearn.linear_model.RidgeRegression"
