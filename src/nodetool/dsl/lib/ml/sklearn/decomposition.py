...
class NMFNode(GraphNode):
    ...
    NMFInit: typing.ClassVar[type] = (
        nodetool.nodes.lib.ml.sklearn.decomposition.NMFNode.NMFInit
    )
    ...
    init: nodetool.nodes.lib.ml.sklearn.decomposition.NMFNode.NMFInit = Field(
        default=nodetool.nodes.lib.ml.sklearn.decomposition.NMFNode.NMFInit.RANDOM,
    ...
    def get_node_type(cls):
        return "lib.ml.sklearn.decomposition.NMF"
...
class PCANode(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.ml.sklearn.decomposition.PCA"
...
class TruncatedSVDNode(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.ml.sklearn.decomposition.TruncatedSVD"
