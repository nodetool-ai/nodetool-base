...
class GradientBoostingClassifierNode(GraphNode):
    ...
    def get_node_type(cls):
        return "lib.ml.sklearn.ensemble.GradientBoostingClassifier"
...
class GradientBoostingRegressorNode(GraphNode):
    ...
    GradientBoostingLoss: typing.ClassVar[type] = (
        nodetool.nodes.lib.ml.sklearn.ensemble.GradientBoostingLoss
    )
    X_train: types.NPArray | GraphNode | tuple[GraphNode, str] = Field(
        default=types.NPArray(type="np_array", value=None, dtype="<i8", shape=(1,)),
        description="Training features",
    ...
    loss: nodetool.nodes.lib.ml.sklearn.ensemble.GradientBoostingLoss = Field(
        default=nodetool.nodes.lib.ml.sklearn.ensemble.GradientBoostingLoss.SQUARED_ERROR,
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.ml.sklearn.ensemble.GradientBoostingRegressor"
...
class RandomForestClassifierNode(GraphNode):
    ...
    RandomForestCriterion: typing.ClassVar[type] = (
        nodetool.nodes.lib.ml.sklearn.ensemble.RandomForestCriterion
    )
    X_train: types.NPArray | GraphNode | tuple[GraphNode, str] = Field(
        default=types.NPArray(type="np_array", value=None, dtype="<i8", shape=(1,)),
        description="Training features",
    ...
    criterion: nodetool.nodes.lib.ml.sklearn.ensemble.RandomForestCriterion = Field(
        default=nodetool.nodes.lib.ml.sklearn.ensemble.RandomForestCriterion.GINI,
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.ml.sklearn.ensemble.RandomForestClassifier"
...
class RandomForestRegressorNode(GraphNode):
    ...
    RandomForestLoss: typing.ClassVar[type] = (
        nodetool.nodes.lib.ml.sklearn.ensemble.RandomForestLoss
    )
    X_train: types.NPArray | GraphNode | tuple[GraphNode, str] = Field(
        default=types.NPArray(type="np_array", value=None, dtype="<i8", shape=(1,)),
        description="Training features",
    ...
    criterion: nodetool.nodes.lib.ml.sklearn.ensemble.RandomForestLoss = Field(
        default=nodetool.nodes.lib.ml.sklearn.ensemble.RandomForestLoss.SQUARED_ERROR,
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.ml.sklearn.ensemble.RandomForestRegressor"
