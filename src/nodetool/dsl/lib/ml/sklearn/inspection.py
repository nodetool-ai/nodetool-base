...
class PartialDependenceDisplayNode(GraphNode):
    ...
    PartialDependenceKind: typing.ClassVar[type] = (
        nodetool.nodes.lib.ml.sklearn.inspection.PartialDependenceKind
    )
    ...
    kind: nodetool.nodes.lib.ml.sklearn.inspection.PartialDependenceKind = Field(
        default=nodetool.nodes.lib.ml.sklearn.inspection.PartialDependenceKind.AVERAGE,
        description="Kind of partial dependence result",
    )

    @classmethod
    def get_node_type(cls):
        return "lib.ml.sklearn.inspection.PartialDependenceDisplay"
...
class PartialDependenceNode(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.ml.sklearn.inspection.PartialDependence"
...
class PermutationImportanceNode(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.ml.sklearn.inspection.PermutationImportance"
