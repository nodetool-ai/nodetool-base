...
class RecursiveFeatureEliminationNode(GraphNode):
    ...
    def get_node_type(cls):
        return "lib.ml.sklearn.feature_selection.RecursiveFeatureElimination"
...
class SelectKBestNode(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.ml.sklearn.feature_selection.SelectKBest"
...
class VarianceThresholdNode(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.ml.sklearn.feature_selection.VarianceThreshold"
