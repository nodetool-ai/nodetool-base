...
class Document(SingleOutputGraphNode[types.SVGRef], GraphNode[types.SVGRef]):
    ...
    content: str | types.SVGElement | list[types.SVGElement] | OutputHandle[str | types.SVGElement | list[types.SVGElement]] = connect_field(default=[], description='SVG content')
