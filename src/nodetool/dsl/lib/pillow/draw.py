...
class RenderText(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    font: types.FontRef | OutputHandle[types.FontRef] = connect_field(default=types.FontRef(type='font', name='DejaVuSans', source=nodetool.metadata.types.FontSource.SYSTEM, url='', weight='regular'), description='The font to use. Supports system fonts, Google Fonts, and custom URLs.')
