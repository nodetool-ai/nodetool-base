...
class AdaptiveContrast(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    """
    ...
    image: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='The image to adjust the contrast for.')
    clip_limit: float | OutputHandle[float] = connect_field(default=2.0, description='Clip limit for adaptive contrast.')
    grid_size: int | OutputHandle[int] = connect_field(default=8, description='Grid size for adaptive contrast.')
...
class Brightness(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    factor: float | int | OutputHandle[float | int] = connect_field(default=1.0, description='Factor to adjust the brightness. 1.0 means no change.')
...
class Color(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    image: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='The image to adjust the brightness for.')
    factor: float | OutputHandle[float] = connect_field(default=1.0, description='Factor to adjust the contrast. 1.0 means no change.')
...
class Detail(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    image: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='The image to detail.')
...
class EdgeEnhance(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    image: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='The image to edge enhance.')
...
class Equalize(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    image: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='The image to equalize.')
...
class RankFilter(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    image: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='The image to rank filter.')
    size: int | OutputHandle[int] = connect_field(default=3, description='Rank filter size.')
    rank: int | OutputHandle[int] = connect_field(default=3, description='Rank filter rank.')
...
class Sharpen(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    image: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='The image to sharpen.')
...
class UnsharpMask(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    image: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='The image to unsharp mask.')
    radius: int | OutputHandle[int] = connect_field(default=2, description='Unsharp mask radius.')
    percent: int | OutputHandle[int] = connect_field(default=150, description='Unsharp mask percent.')
    threshold: int | OutputHandle[int] = connect_field(default=3, description='Unsharp mask threshold.')
