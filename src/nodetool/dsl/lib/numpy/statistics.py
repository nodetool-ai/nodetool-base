...
class ArgMaxArray(SingleOutputGraphNode[types.NPArray | int], GraphNode[types.NPArray | int]):
    """
...
class ArgMinArray(SingleOutputGraphNode[types.NPArray | int], GraphNode[types.NPArray | int]):
    """
...
class MaxArray(SingleOutputGraphNode[types.NPArray | float | int], GraphNode[types.NPArray | float | int]):
    """
...
class MeanArray(SingleOutputGraphNode[types.NPArray | float | int], GraphNode[types.NPArray | float | int]):
    """
...
class MinArray(SingleOutputGraphNode[types.NPArray | float | int], GraphNode[types.NPArray | float | int]):
    """
...
class SumArray(SingleOutputGraphNode[types.NPArray | float | int], GraphNode[types.NPArray | float | int]):
    """
