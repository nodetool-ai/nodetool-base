...
class Insert(SingleOutputGraphNode[Any], GraphNode[Any]):
    ...
    records: list[dict[str, Any]] | dict[str, Any] | OutputHandle[list[dict[str, Any]] | dict[str, Any]] = connect_field(default=[], description='One or multiple rows to insert')
...
class Upsert(SingleOutputGraphNode[Any], GraphNode[Any]):
    ...
    records: list[dict[str, Any]] | dict[str, Any] | OutputHandle[list[dict[str, Any]] | dict[str, Any]] = connect_field(default=[], description='One or multiple rows to upsert')
