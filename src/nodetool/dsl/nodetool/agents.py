...
class ResearchAgent(GraphNode[dict[str, Any]]):
    ...
    tools: list[types.ToolName] | OutputHandle[list[types.ToolName]] = connect_field(default=[types.ToolName(type='tool_name', name='google_search'), types.ToolName(type='tool_name', name='browser')], description='Additional research tools to enable (workspace tools are always included)')
