...
class ChunkToAudio(GraphNode[nodetool.nodes.nodetool.audio.ChunkToAudio.OutputType]):
    ...
    chunk: types.Chunk | OutputHandle[types.Chunk] = connect_field(default=types.Chunk(type='chunk', node_id=None, thread_id=None, workflow_id=None, content_type='text', content='', content_metadata={}, done=False, thinking=False), description='Stream of audio chunks')
