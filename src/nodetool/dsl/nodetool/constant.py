...
class Model3D(SingleOutputGraphNode[types.Model3DRef], GraphNode[types.Model3DRef]):
    ...
    value: types.Model3DRef | OutputHandle[types.Model3DRef] = connect_field(default=types.Model3DRef(type='model_3d', uri='', asset_id=None, data=None, metadata=None, format=None), description=None)
