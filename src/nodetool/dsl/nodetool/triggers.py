...
class TriggerNode[DiscordBotTriggerOutput](
...
class TriggerNode[FileWatchTriggerOutput](
    SingleOutputGraphNode[typing.Any], GraphNode[typing.Any]
):
    max_events: int | OutputHandle[int] = connect_field(
        default=0, description="Maximum number of events to process (0 = unlimited)"
...
class TriggerNode[IntervalTriggerOutput](
    SingleOutputGraphNode[typing.Any], GraphNode[typing.Any]
):
    max_events: int | OutputHandle[int] = connect_field(
        default=0, description="Maximum number of events to process (0 = unlimited)"
...
class TriggerNode[ManualTriggerOutput](
    SingleOutputGraphNode[typing.Any], GraphNode[typing.Any]
):
    max_events: int | OutputHandle[int] = connect_field(
        default=0, description="Maximum number of events to process (0 = unlimited)"
...
class TriggerNode[TelegramBotTriggerOutput](
    SingleOutputGraphNode[typing.Any], GraphNode[typing.Any]
):
    max_events: int | OutputHandle[int] = connect_field(
        default=0, description="Maximum number of events to process (0 = unlimited)"
...
class TriggerNode[WebhookTriggerOutput](
    SingleOutputGraphNode[typing.Any], GraphNode[typing.Any]
):
    max_events: int | OutputHandle[int] = connect_field(
        default=0, description="Maximum number of events to process (0 = unlimited)"
