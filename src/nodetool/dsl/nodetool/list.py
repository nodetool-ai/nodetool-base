...
class Slice(SingleOutputGraphNode[list[Any]], GraphNode[list[Any]]):
    ...
    values: list[Any] | OutputHandle[list[Any]] = connect_field(default=[], description='The input list to slice.')
    start: int | OutputHandle[int] = connect_field(default=0, description='Starting index (inclusive). Negative values count from end.')
    stop: int | OutputHandle[int] = connect_field(default=0, description='Ending index (exclusive). 0 means slice to end of list.')
    step: int | OutputHandle[int] = connect_field(default=1, description='Step between elements. Negative for reverse order.')
