...
class Embedding(SingleOutputGraphNode[types.NPArray], GraphNode[types.NPArray]):
    ...
    model: nodetool.nodes.gemini.text.EmbeddingModel = Field(default=nodetool.nodes.gemini.text.EmbeddingModel.TEXT_EMBEDDING_004, description='The embedding model to use')
