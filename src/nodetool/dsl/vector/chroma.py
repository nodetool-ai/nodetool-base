...
class IndexAggregatedText(SingleOutputGraphNode[typing.Any], GraphNode[typing.Any]):
    ...
    text_chunks: list[types.TextChunk | str] | OutputHandle[list[types.TextChunk | str]] = connect_field(default=[], description='List of text chunks to index')
...
class IndexEmbedding(SingleOutputGraphNode[typing.Any], GraphNode[typing.Any]):
    ...
    index_id: str | list[str] | OutputHandle[str | list[str]] = connect_field(default='', description='The ID to associate with the embedding')
    metadata: dict | list[dict] | OutputHandle[dict | list[dict]] = connect_field(default={}, description='The metadata to associate with the embedding')
