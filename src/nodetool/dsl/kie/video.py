...
class Seedance15ProBaseNode(SingleOutputGraphNode[types.VideoRef], GraphNode[types.VideoRef]):
    """
    ...
    AspectRatio: typing.ClassVar[type] = nodetool.nodes.kie.video.Seedance15ProBaseNode.AspectRatio
    Resolution: typing.ClassVar[type] = nodetool.nodes.kie.video.Seedance15ProBaseNode.Resolution
    Duration: typing.ClassVar[type] = nodetool.nodes.kie.video.Seedance15ProBaseNode.Duration

    aspect_ratio: nodetool.nodes.kie.video.Seedance15ProBaseNode.AspectRatio = Field(default=nodetool.nodes.kie.video.Seedance15ProBaseNode.AspectRatio.V16_9, description='The aspect ratio of the generated video.')
    resolution: nodetool.nodes.kie.video.Seedance15ProBaseNode.Resolution = Field(default=nodetool.nodes.kie.video.Seedance15ProBaseNode.Resolution.R720P, description='Video resolution - 480p for faster generation, 720p for higher quality.')
    duration: nodetool.nodes.kie.video.Seedance15ProBaseNode.Duration = Field(default=nodetool.nodes.kie.video.Seedance15ProBaseNode.Duration.D8, description='Duration of the video in seconds.')
    fixed_lens: bool | OutputHandle[bool] = connect_field(default=False, description='Lock camera for stable, static shots. If false, allow dynamic camera movement.')
    generate_audio: bool | OutputHandle[bool] = connect_field(default=False, description='Whether to generate audio for the video. Note: enabling audio will increase the generation cost.')

    @classmethod
    def get_node_class(cls) -> type[BaseNode]:
        return nodetool.nodes.kie.video.Seedance15ProBaseNode
...
class Seedance15ProImageToVideo(SingleOutputGraphNode[types.VideoRef], GraphNode[types.VideoRef]):
    """
    ...
    fixed_lens: bool | OutputHandle[bool] = connect_field(default=False, description='Lock camera for stable, static shots. If false, allow dynamic camera movement.')
    generate_audio: bool | OutputHandle[bool] = connect_field(default=False, description='Whether to generate audio for the video. Note: enabling audio will increase the generation cost.')
    prompt: str | OutputHandle[str] = connect_field(default='A cinematic video with smooth motion, natural lighting, and high detail.', description='The text prompt describing the video. Min 3, max 2500 characters.')
    image1: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='First source image for the video generation (0-2 images supported).')
    image2: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='Second source image for the video generation (optional).')

    @classmethod
    def get_node_class(cls) -> type[BaseNode]:
        return nodetool.nodes.kie.video.Seedance15ProImageToVideo
...
class Seedance15ProTextToVideo(SingleOutputGraphNode[types.VideoRef], GraphNode[types.VideoRef]):
    """
    ...
    fixed_lens: bool | OutputHandle[bool] = connect_field(default=False, description='Lock camera for stable, static shots. If false, allow dynamic camera movement.')
    generate_audio: bool | OutputHandle[bool] = connect_field(default=False, description='Whether to generate audio for the video. Note: enabling audio will increase the generation cost.')
    prompt: str | OutputHandle[str] = connect_field(default='A cinematic video with smooth motion, natural lighting, and high detail.', description='The text prompt used to generate the video. Min 3, max 2500 characters.')

    @classmethod
    def get_node_class(cls) -> type[BaseNode]:
        return nodetool.nodes.kie.video.Seedance15ProTextToVideo
