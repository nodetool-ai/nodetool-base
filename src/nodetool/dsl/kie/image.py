...
class IdeogramV3TextToImage(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    prompt: str | OutputHandle[str] = connect_field(default='', description='Description of the image to generate.')
    ...
    expand_prompt: bool | OutputHandle[bool] = connect_field(default=True, description='Whether to expand/augment the prompt.')
    image_size: nodetool.nodes.kie.image.IdeogramV3TextToImage.ImageSize = Field(default=nodetool.nodes.kie.image.IdeogramV3TextToImage.ImageSize.SQUARE_HD, description='The size of the output image.')
