...
class Flatten(BaseNode):
    ...
    def _flatten(self, lst: list[Any], current_depth: int = 0):
        # ⚡ Bolt Optimization: Use generator (yield/yield from) to process elements lazily.
        # This avoids creating multiple intermediate arrays and excessive memory allocation
        # during deeply nested list processing, reducing call stack overhead.
        for item in lst:
