...
Use the Commander node to perform a lightweight market analysis with
...
3. **Autonomous Research** – Launch the Commander with dynamic output schema.
...
from nodetool.dsl.nodetool.agents import Commander
