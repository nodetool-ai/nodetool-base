...
class SimpleTriggerOutput(TypedDict):
    data: dict[str, Any]
    timestamp: str
    source: str
    event_type: str
...
class QueueBasedTrigger(TriggerNode[SimpleTriggerOutput]):
