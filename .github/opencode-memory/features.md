...
## 2026-01-20 - GPT Image 1.5 Models
...
- **Description:** Added support for OpenAI's GPT Image 1.5 text-to-image and image-to-image generation via Kie.ai. The new nodes support multiple aspect ratios (1:1, 2:3, 3:2) and quality settings (medium, high).
