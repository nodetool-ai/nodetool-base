...
Reads all workflow JSON files in the nodetool-base examples directory
...
def create_workflow_graph(examples_dir: Path, single_file: str | None = None):
    ...
    save_image = SaveImageFile(
        ...
        folder="src/nodetool/assets/nodetool-base",
...
def get_examples_directory() -> Path:
    """Get the path to the nodetool-base examples directory."""
    script_dir = Path(__file__).parent
    examples_dir = script_dir / ".." / "src" / "nodetool" / "examples" / "nodetool-base"
